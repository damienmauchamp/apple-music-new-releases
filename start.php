...
define("WEEKDAYS_NAMES", serialize([
	1 => "lundi",
	2 => "mardi",
	3 => "mercredi",
	4 => "jeudi",
...
define("MONTHS_NAMES_SHORT", serialize([
	1 => "janv.",
	2 => "févr.",
	3 => "mars",
	4 => "avr.",
...
function printOut(string $type, string $text, bool $date = true): int | false {
	return file_put_contents($type, sprintf("%s{$text}\n", $date ? ('[' . date('Y-m-d H:i:s') . '] ') : ''));
}

function printGui(string $text, bool $date = true): int | false {
	return printOut('php://output', $text, $date);
}

function printCli(string $text, bool $date = true): int | false {
	return printOut('php://stdout', $text, $date);
}
